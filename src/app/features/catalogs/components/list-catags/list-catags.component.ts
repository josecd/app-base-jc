...
@Component({
  selector: 'app-list-catags',
  standalone: true,
  imports: [
    MatIcon,
    MatButton
  ],
  templateUrl: './list-catags.component.html',
  styleUrl: './list-catags.component.scss'
})
export default class ListCatagsComponent {
  ...
  openAddModule() {
    const dialogRef = this.dialog.open(AddCatalogsComponent);
